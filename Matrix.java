...
public class Matrix {
    ...
    public static Matrix make(int[] array) {
        ...
        Matrix M = Utilities.listToMatrix(Arrays.asList(data));
    ...
    public void scramble(boolean type) {
        ...
        n = data[0].length;
        m = data.length;
        row1 = Elliptic.getRandom().nextInt(m);
        row2 = Utilities.getNotEqualTo(row1, m);
        col1 = Elliptic.getRandom().nextInt(n);
        col2 = Utilities.getNotEqualTo(col1, m);
    ...
    public static String[][] additionCode = new String[][]{
        {"01", "10", "11", "00"}, {"10", "11", "00", "01"}, {"11", "00", "01", "10"}, {"00", "01", "10", "11"}
    };
